...
export default function SSXChip(props) {
  ...
  function setCalibratedPosition(name) {
    setCalibratedPositions((prevState) => ({
      ...prevState,
      [name]: [
        props.sampleMotorVertical.position,
        props.sampleMotorHorizontal.position,
        props.phiZMotor.position,
      ],
    }));
  }
  ...
  function handleSubmit(key, arg, e) {
    switch (key) {
      case 'move_to': {
        ...
        props.setAttribute(props.phiZMotor.name, chipState[`${arg}_z`]);
      }
