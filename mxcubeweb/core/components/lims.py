...
class Lims(ComponentBase):
    ...
    def set_proposal(self, proposal_number: str):
        ...
        self.select_session(current_user.username, proposal_number)
    ...
    def select_session(self, username: str, session_id: str) -> bool:
        """Select session.

        Params:
            username: The username of the user selecting the session.
        ...
        try:
            session = HWR.beamline.lims.set_active_session_by_id(session_id, username=username)
